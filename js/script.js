...
const featuredSpeakers = [{
  ...
  profilePicture: '../docs/resources/img/GianniInfantinoWWC.png',
  backgroundPicture: '../docs/resources/img/chessboard.svg',
...
},
{
  ...
  profilePicture: '../docs/resources/img/JurgenKlinsmann.png',
  backgroundPicture: '../docs/resources/img/chessboard.svg',
...
},
{
  ...
  profilePicture: '../docs/resources/img/Qahtani.png',
  backgroundPicture: '../docs/resources/img/chessboard.svg',
...
},
{
  ...
  profilePicture: '../docs/resources/img/OthmanZarzour.png',
  backgroundPicture: '../docs/resources/img/chessboard.svg',
...
},
{
  ...
  profilePicture: '../docs/resources/img/OrjanLundberg.png',
  backgroundPicture: '../docs/resources/img/chessboard.svg',
...
},
{
  ...
  profilePicture: '../docs/resources/img/CynathiaJHebsgaard.png',
  backgroundPicture: '../docs/resources/img/chessboard.svg',
...
const speakersList = document.querySelector('.featured-speakers-list');
const seeMore = document.getElementById('button-see-more');
